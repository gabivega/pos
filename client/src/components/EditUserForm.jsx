...
const EditUserForm = (props) => {
  ...
  const date =
    splittedRawDate[2] + "-" + splittedRawDate[1] + "-" + splittedRawDate[0];
    ...
    <div>
      <div className="flex flex-col items-center gap-4 mt-6 mb-10">
        ...
        <form
          ...
          ref={formRef}
        >
          <h2 className="text-xl font font-semibold text-blue">
            Editar Cuenta
          </h2>
          <div className="flex flex-row items-start border-b border-slate-400 w-[100%]">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Email:</h2>
            </div>
          ...
          <div className="flex flex-row items-start border-b border-slate-400 w-[100%]">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Usuario desde:</h2>
            </div>
            <div className="basis-2/3 flex flex-row justify-between w-[100%]">
              <p>{date}</p>
            </div>
          ...
          <div className="flex flex-row  border-b border-slate-400 w-[100%] pb-1">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Apellido:</h2>
            </div>
          ...
          <div className="flex flex-row  border-b border-slate-400 w-[100%] pb-1">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Teléfono:</h2>
            </div>
            <div className="flex flex-row basis-2/3 justify-between">
              <input
                type="text"
          ...
          <div className="flex flex-row  border-b border-slate-400 w-[100%] pb-1">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Ciudad:</h2>
            </div>
            <div className="flex flex-row basis-2/3 justify-between">
              <input
                type="text"
          ...
          <div className="flex flex-row  border-b border-slate-400 w-[100%] pb-1">
            <div className="basis-1/3">
              <h2 className="text-l font-regular ">Direccion:</h2>
            </div>
            <div className="flex flex-row basis-2/3 justify-between w-[100%]">
              <input
                type="text"
